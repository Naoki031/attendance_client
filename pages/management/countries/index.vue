<template>
  <v-container fluid class="py-6 px-6">
    <div class="d-flex align-center justify-space-between mb-5">
      <div>
        <div class="text-h5 font-weight-bold">{{ $t('countries.title') }}</div>
      </div>
...
const headers = computed(() => [
  ...
  { title: t('common.capital'), key: 'capital' },
...
const {
  ...
  onCloseDelete,
  resetFilters,
} = useCrudPage<CountryModel, typeof CountryService>(CountryService, {
  filters: { search: '' },
})
/* END DEFINE STATE */
</script>
