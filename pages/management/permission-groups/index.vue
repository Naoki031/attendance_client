<template>
  <v-container fluid class="py-6 px-6">
    <div class="d-flex align-center justify-space-between mb-5">
      <div>
        <div class="text-h5 font-weight-bold">{{ $t('permissionGroups.title') }}</div>
      </div>
...
const headers = computed(() => [
  ...
  { title: t('permissionGroups.permissions'), key: 'permissions' },
...
const {
  ...
  onCloseDelete,
  resetFilters,
} = useCrudPage<PermissionGroupModel, typeof PermissionGroupService>(PermissionGroupService, {
  filters: { search: '' },
})
/* END DEFINE STATE */
</script>
